    ...
    <div class="container mt-5">
        ...
        while ($row = oci_fetch_assoc($statement)) {
            echo "<li class='list-group-item'>
               " . $row['MENU'] . " 
              <a href='eliminar_menu.php?id=" . $row['ID_MENU'] . "' class='btn btn-danger btn-sm'>Eliminar</a>
              <a href='editar_menu.php?id=" . $row['ID_MENU'] . "' class='btn btn-secondary btn-sm'>Editar</a>
          </li>";
        }
        echo "</ul>";
