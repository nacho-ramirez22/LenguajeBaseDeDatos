...
<body>
            ...
            <div class="container-fluid">
                ...
                <div class="collapse navbar-collapse" id="navbarNav">
                    <ul class="navbar-nav">
                        ...
                        <li class="nav-item">
                            <a class="nav-link active" href="tour.php">Tour</a>
                        </li>
                        <li class="nav-item">
    ...
    <div class="container mt-5">
        ...
        while ($row = oci_fetch_assoc($statement)) {
            echo "<li class='list-group-item'>" . $row['TIPO'] . " <a href='eliminar_tour.php?id=" . $row['ID_TOUR'] . "' class='btn btn-danger btn-sm'>Eliminar</a>  <a href='editar_tour.php?id=" . $row['ID_TOUR'] . "' class='btn btn-secondary btn-sm'>Editar</a></li>";
        }
        echo "</ul>";
        ...
        <div class="row">
            <div class="col-12 text-center">
                ...
                <form action="Agregar_tour.php" method="POST">
